...
import { IonPage, IonHeader, IonToolbar, IonSearchbar, IonButtons, IonButton, IonContent, IonIcon, IonList, IonItem, IonLabel } from "@ionic/react";
...
const Scores = (props : RouteComponentProps) => {
    ...
    const scorecard = useStreamQueries(Scorecard, () => {return [{client: (user as any).party}] }).contracts
                ...
                <div className="proj-wrapper">
                    ...
                    <IonList>
                         ...
                         </IonItem>
                        {
                            ...
                            : (
                                <IonItem lines="none"><IonLabel><p>No scores found</p></IonLabel></IonItem>
                            )
                        }
                    </IonList>
